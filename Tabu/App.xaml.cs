...
{
    public AudioPlayerViewModel BackgroundAudioView = new AudioPlayerViewModel("BackgroundMusic.wav");
    ...
    public App()
    {
        ...
        if (!Preferences.ContainsKey("background_music_state")) { Preferences.Set("bckground_music_state", true); }

        if (Preferences.Get("background_music_state", true))
        {
